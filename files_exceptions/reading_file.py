...
# with open(filepath, 'r') as students: # 'r' is an optional parameter for opening mode, r is default mode that open
#         in READ ONLY mode.
...
#---------------------READING FROM LINE----------
with open(filepath, 'a') as students: # 'a' is for append, that appends the value
#   to the file content, 'w' is for write, that truncates the file and adds new content.
